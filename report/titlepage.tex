...
\newcommand{\makemytitle}{%
  \begin{titlepage}%
    \begin{tikzpicture}
      ...
      \node[inner sep = 10mm, anchor = north west] at (bgnw) {\pgfimage[height=20mm]{pics/kit-logo.pdf}};
      \node[inner sep = 10mm, anchor = north east] at (bgne) {\pgfimage[height=20mm]{pics/algo-logo.pdf}};
